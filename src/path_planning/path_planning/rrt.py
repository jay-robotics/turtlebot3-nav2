...
smooth_path_has_collision = check_if_smooth_path_collide(smooth_path_final)
if smooth_path_has_collision:
    print("smooth_path_final is NOT collision free")
else:
    print("smooth_path_final is collision free")
